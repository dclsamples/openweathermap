				...
				<div id="api-output" style={{ width: "100%" }}>
					<div style={{ textAlign: "left", width: "33%", float: "left", padding: "10px 10px 10px 10px" }}>
						...
						<p>
							...
							<i>Get current weather conditions along with LAT &amp; LONG which are used to get the weekly outlook.</i>
						</p>
					...
					<div style={{ textAlign: "left", width: "33%", float: "left", padding: "10px 10px 10px 10px" }}>
						...
						<p>
							<strong>Purpose: </strong>
							<i>Get today's forecast along with upcoming 7 days (weekly outlook).</i>
						</p>
