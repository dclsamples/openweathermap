	...
	return (
		<div>
			...
			<form onSubmit={getCurrentWeather}>
				<input ref={cityNameRef} type="text" placeholder="City" maxLength="50" value={city} onChange={(e) => setCity(e.target.value)} />
				<br />
			...
			<div>
				<WeeklyOutlook weeklyWeather={weeklyWeather} />
			</div>

			<div>
				<ApiOutput currentWeather={currentWeather} weeklyWeather={weeklyWeather} />
			</div>
		</div>
	);
};
